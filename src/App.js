  ...
  const [contentArray, setContentArray] = useState([
    {
      ...
      und innovative Sales-Strategie aufzeigen, wie sich virtuelle Shopping-Rund-gänge als potentielles Einkaufserlebnis für den Fan/ Käufer oder spezifische Zielgruppen gewinnbringend für zukünftige Visual-Merch-Online-Shops einsetzen lassen.
    ...
    },
    {
      ...
      <div class="app__extraSpace"></div>
      Gerade beim Sport spielen Emotionen eine sehr große und entscheidende Rolle, aber auch bei persönlichenKaufentscheidungen - in Form von emotionalen Impulsen - denn gerade diese Impulse können auch durch neue virtuelle Einkaufs - und Shoppingwelt - in Form eines virtuellen Rundgangs, oder einer 3-D-Tour ausgelöst und verstärkt werden.`,
    ...
    },
    {
      ...
      <div class="app__extraSpace"></div> 
      Diese spezifischen Zielgruppen könnten mit meinem Konzept und der Dartsellung, dass gesamte Merchandising-Produktportfolio von allen Seiten aktiv betrachten und digitalisiert eingespielte Produktinformationen erhalten, um so einen optimalen Eindruck von Größe, Form und ggf. sogar von den ver-
      wendeten und nachhaltigen Rohstoffen des jeweiligen Produktes zu bekommen.
      <div class="app__extraSpace"></div> 
    ...
    },
    {
      ...
      text: `Inszenierungen erzählen Geschichten, in denen sich auch der Fan/ Kunde mit positiven Empfindungen/ Impulsen wiederfindet kann. Diese positiven Empfindungen erhöhen die Bereitschaft, sich länger und „intensiver“ in einem Visual–Merch–Store aufzuhalten: <br>
    ...
    },
    {
      ...
      <div class="app__extraSpace"></div> 
      + Kunden/ Fans bekommen, verglichen mit normalen Online-Shopping-Anwendungen, umfangreichere Informationen zu Produkten und deren Komponenten. Stichwort Nachhaltigkeit!
      <div class="app__extraSpace"></div> 
      + VR-Kunden können die - auf den Verein/ Unternehmen abgestimmten 3D-Merch-Produkte in ihrer eigentlichen Größe und Form in einer virtuellen 3D-Umgebung und über natürliche Nutzerschnittstellen „anfassen“, inspizieren und testen.`,
    ...
    },
    {
      ...
      <div class="app__extraSpace"></div> 
      Darüber hinaus kann ein Outsourcing sämtlicher operativer Prozesse in diesem Bereich nicht nur kosten- und personaloptimiert und somit effizienter genutzt werden, so dass das Management/ Vereinsführung sich auf sein Kern-Business fokussieren kann. Dadurch könnten wiederum neue Synergie- potentiale generiert werden, die für eine zukünftig positive wirtschaftliche und finanzielle Entwicklung für jeden Verein/ Unternehmen unabdingbar sind.
      <div class="app__extraSpace"></div> 
