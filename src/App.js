  ...
  const [contentArray, setContentArray] = useState([
    {
      ...
      text: `Mit diesem Konzept möchte ich Profi-Sportvereinen und Unternehmen eine neue und innovative Sales-Strategie aufzeigen, wie sich virtuelle Shopping-Rund-gänge als potentielles Einkaufserlebnis für den Fan/ Käufer oder spezifische Zielgruppen gewinnbringend für zukünftige Visual-Merch-Online-Shops einsetzen lassen.
      <br><br>
      Darüber hinaus möchte ich mit meinem Konzept einen Relaunch herkömmlicher Shop-in-Shop-Systeme - in Verbindung mit einer 3-D Visualisierung/ Animation   und mit einem smarten integrierten Bezahlsystem vorstellen.
      Ich bin der festen Überzeugung, dass eine erfolgteiche Umsetzung von meinem Konzept - in Verbindung mit der smarten Funktionsweise – dazu beitragen kann, die Identifikation und Bindung der Fans mit dem Verein / Marke zu verstärken, das Kaufverhalten der jeweiligen Zielgruppen zu beeinflusst und somit letztlich   den Merch-Umsatz signifikant zu erhöht. Stichwort: Höhere Verweildauer im Shop.
      Mit meiner Intention verfolge ich aber auch den Ansatz, dass Interesse für Visual Sport- Merchandising-Shopping verstärkt zu wecken und gleichzeitig zu inspirieren, um damit potentielle „Berührungsängste“ abzubauen...Mit dem Ziel:                                                                                           <br>                                          
    ...
    },
    {
      ...
      <br><br>
      Gerade beim Sport spielen Emotionen eine sehr große und entscheidende Rolle, aber auch bei persönlichenKaufentscheidungen - in Form von emotionalen Impulsen - und gerade diese Impulse können auch durch neue virtuelle Einkaufs - und Shoppingwelt - hierbei in Form eines virtuellen Rundgangs, oder einer 3-D-Tour ausgelöst und verstärkt werden.`,
    ...
    },
    {
      ...
      <br><br>
      Diese spezifischen Zielgruppen könnten mit meinem Konzept und der Dartsellung, dass gesamte Merchandising-Produktportfolio von allen Seiten aktiv betrachten   und digitalisiert eingespielte Produktinformationen erhalten, um so einen optimalen Eindruck von Größe, Form und ggf. sogar von den verwendeten und nachhaltigen Rohstoffen des jeweiligen Produktes zu bekommen.
      <br><br> 
      ...
      <br><br>
      Ziel: Der neue „Digi-Merch-Shop“ als neues Profit-Center, mit einem hohen ROI. Daraus ergeben sich auch weitere interessante Parameter für den Verein, wie z.B. optimierte Erkenntnisse über das Kaufverhalten von sog. „Rennern & Pennern“. Die daraus erhaltenen Erkenntnisse bilden die Basis für eine effiziente Portfolio-Optimierung und die zukünftige Merchandising-Ausrichtung.
      <br><br>
      Die optimale Waren- und Produktpräsentation in Verbindung mit einem - auf den Verein abgestimmtes Story-Telling - mit der Funktion, die wichtige Beziehung zwischen Verein - Fan zu verstärkt, führt weiterhin zu einer zu einer positiven Customer Journey und damit letztlich zu einer zielführenden Umsatz- und Ertragssteigerung.`,
    ...
    },
    {
      ...
      text: `Inszenierungen erzählen Geschichten, in denen sich auch der Fan/Kunde mit positiven Empfindungen/Impulsen wiederfindet kann. Diese positiven Empfindungen erhöhen die Bereitschaft, sich länger und „intensiver“ in einem Visual–Merch–Store aufzuhalten:
      ...
      <br><br>
      <b>Durch eine kreative visuelle Positionierung können leblose Merchandising-Produkte lebendig erscheinen, mit dem Ziel: „Was ich jetzt finde, nehme ich mit“. Das ist der Belohnungseffekt. So wird aus einem „Das möchte ich vielleicht haben“ ein „Das brauche ich unbedingt“.
      <br><br>
    ...
    },
    {
      ...
      text: `+ Smarte Suchfunktionalität durch Spracheingabe-Optionen plus Persönlichkeit/Individualität (optional durch Spracheingabe und interaktive Assistenzsysteme, für einen Einkaufs-Support)
      <br><br>
      ...
      <br><br>
      + Kunden bekommen, verglichen mit normalen Online-Shopping- Anwendungen, umfangreichere Informationen zu Produkten und deren Komponenten.Stichwort Nachhaltigkeit
      <br><br>
      + VR-Kunden können die - auf den Verein/ Unternehmen abgestimmten 3D-Merch-Produkte in ihrer eigentlichen Größe, Gewicht und Form in einer virtuellen 3D-Umgebung und über            natürliche Nutzerschnittstellen „anfassen“, inspizieren und testen.`,
    ...
    },
    {
      ...
      <br><br>
      Ein neues, innovatives und stimmiges, sowie auf den Verein/Unternehmen abgestimmtes Merchandising-Konzept supportet die Verantwortlichen/Entscheidungsträgern, mehr Umsatz, Erträge und neues Wachstum in Zukunft zu generieren.
      <br><br>
      Darüber hinaus kann ein Outsourcing sämtlicher operativer Prozesse in diesem Bereich nicht nur kosten- und personaloptimiert und somit effizienter genutzt werden, so dass das Management/ Vereinsführung sich auf sein Kern-Business fokussieren kann. Dadurch könnten wiederum neue Synergiepotentiale generiert werden, die für eine zukünftig positive wirtschaftliche und finanzielle Entwicklung für jeden Verein/ Unternehmen unabdingbar sind.
      <br><br>
